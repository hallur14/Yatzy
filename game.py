...
class MainWindow(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.rollBtn = Button(self, text='ROLL', height=1, width=11, command=self.roll, font=('Verdana', 14),
                              fg='white', bg='brown')
        ...
        self.sumBtn = Button(self, text='Sum', height=1, width=13, state='disabled',
        ...
        self.fourOfaKindLabel = Label(self, font=('Verdana', 12), width=10, textvariable=self.fourOfaKindMsg,
                                      fg="green",
                                      bg='white')
    ...
    def validateBigRow(self):
        ...
        self.player1.score += YatziValidor.bigRow(self.player1.currentDice)
...
class YatziValidor(object):
    ...
    def topMatches(currDice, nrOfOccurrances, mode):  # mode 1 for 2,3 or 4 of a kind.
        # mode 2 for two pairs.
        # mode 3 for full house
        # mode 4 three of a kind. mode 5 = four of a kind
        ...
        if mode == 2:
            if len(repetitions) == 2:
                ...
                return 0
                                                      ...
                                                      or [x.value for x in currDice].count(repetitions[0]) == 2):
